                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="flex flex-wrap">
                            <button type="submit" class="inline-block align-middle text-center select-none border font-bold whitespace-no-wrap py-2 px-4 rounded text-base leading-normal text-black no-underline bg-gray-200 hover:bg-gray-700">
                                {{ __('Register') }}
                            </button>
